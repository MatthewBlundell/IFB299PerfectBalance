...
def InfoCar(request, id):
    ...
    #check for it authenication fails when attempting to log in
    ...
    #checks that user has logged in or not and sets variables for their session
...
#returns user if they dont supply a car to look at
def home(request):
